...
Erarbeite ein Architektur- und Stack-Konzept fuer diese App-Idee: $ARGUMENTS
Maszstab sind die Regel-Files unter `${CLAUDE_PLUGIN_ROOT}/rules/`.
Folge der Workflow-Definition in `${CLAUDE_PLUGIN_ROOT}/skills/app-design/SKILL.md`.
