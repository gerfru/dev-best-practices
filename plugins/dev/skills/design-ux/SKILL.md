...
Vollständiges Mapping aller Design-Entscheidungen auf HAX Guidelines, PAIR Patterns,
CHI 2024 Principles, NNG sowie akademische Kurse: `references/framework-mapping.md`
